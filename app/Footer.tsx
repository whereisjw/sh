  ...
  return (
    <div className='mb-[15vh]'>
      <div className="bg-white    text-gray-700 border-t  fixed bottom-0 w-full px-10 pb-5 pt-3 flex justify-between text-xs">
          <Link href={`/`}>
            <div className="flex flex-col items-center space-y-2">
              <svg
                ...
                strokeWidth="1.5"
                stroke="currentColor"
                className={pathname === '/' ? `fill-teal-500 w-6 h-6` : `w-6 h-6`}>
                <path
                  strokeLinecap="round"
          ...
          <Link href={`/community`}>
            <div className="flex flex-col items-center space-y-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className={pathname === '/community'  ? `fill-teal-500 w-6 h-6` : `fill-none stroke-black stroke-[20] w-6 h-6`}>

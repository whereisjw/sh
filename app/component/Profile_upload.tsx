      ...
      <div className="bg-gray-500  border shadow-md rounded-lg px-4 py-8 my-5 text-sm lg:text-base">
        ...
        <div className="border border-gray-400 p-2 flex flex-col items-center text-white font-medium">
          ...
          <Link
            ...
            className="py-3 px-1 border-2 rounded-md w-full text-center my-3 cursor-pointer hover:bg-teal-500   text-lg lg:text-xl focus:ring-2 focus:ring-offset-2 focus:ring-teal-400 focus:border-0 focus:outline-none"
          >
            중고홈짐 등록하기
          </Link>
        </div>
